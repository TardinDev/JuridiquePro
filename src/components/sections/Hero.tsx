            ...
            <motion.div {...slideInView("right", 0.2, 1.1)} className="flex-shrink-0" style={{ perspective: "1200px" }}>
              ...
              >
                ...
                <div className="space-y-3.5">
                  ...
                  <a href="https://wa.me/33758745623" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 group/wa">
                    <div className="flex h-7 w-7 items-center justify-center rounded-md bg-royal/[0.08]">
                    ...
                    <span className="text-sm text-white/60 group-hover/wa:text-white/80 transition-colors">WhatsApp</span>
                  </a>
                </div>
